...
@section('title', 'Tambah Customer 2 (File Path)')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Tambah Customer 2 (File Path)</li>
@endsection
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Tambah Customer 2</h4>
                <p class="card-description">Foto customer diambil dari kamera dan disimpan sebagai <code>file gambar</code> di storage, path-nya disimpan di database</p>

                <form action="{{ route('customer.store2') }}" method="POST" id="customerForm2">
                    @csrf
...
(function() {
    ...
    btnSaveFoto.addEventListener('click', function() {
        ...
        fotoBase64Input.value = capturedData;
